...
BROWSER_SESSION_URL: str = os.getenv("BROWSER_SESSION_URL", "http://YOUR_XEON_IP:8086")
...
MCP_MONTEGALLO_URL: str = os.getenv("MCP_MONTEGALLO_URL", "")
MCP_MONTEGALLO_TOKEN: str = os.getenv("MCP_MONTEGALLO_TOKEN", "")
